...
UCLASS()
class AFPSLaunchPad : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	// Marked with ufcuntion to bind to overlap event
	UFUNCTION()
	...
	/* Angle added on top of actor rotation to launch the character. 
		Marked 'EditInstaceOnly' to allow in-level editing of this property per instance. */
	UPROPERTY(EditInstanceOnly, Category = "LaunchPad")
